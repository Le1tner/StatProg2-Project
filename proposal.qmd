...
**Source:** [https://data-explorer.oecd.org/vis?lc=en&tm=ICT&pg=0&snb=69&df\[ds\]=dsDisseminateFinalDMZ&df\[id\]=DSD_ICT_HH_IND%40DF_IND&df\[ag\]=OECD.STI.DEP&df\[vs\]=1.1&dq=.A........&pd=,&to\[TIME_PERIOD\]=false](https://data-explorer.oecd.org/vis?lc=en&tm=ICT&pg=0&snb=69&df[ds]=dsDisseminateFinalDMZ&df[id]=DSD_ICT_HH_IND%40DF_IND&df[ag]=OECD.STI.DEP&df[vs]=1.1&dq=.A........&pd=,&to[TIME_PERIOD]=false)
...
data_raw = read_csv(here("data", "raw", "ICT.csv"))
```
