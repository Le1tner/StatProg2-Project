...
2. How did the education level change in the last few years in different countries and does the change correlate with the deployment status or income group or the internet or the age? (From 2021-2025)
...
-   *Which variables will you use?*
    ...
    -   Question 2: AGE, EDUCATION_LEVEL, TIME_PERIOD, OBS_VALUE, INCOME_GROUP, Employment Status
...
-   *What analytical approach or method seems appropriate, and why?*
    ...
    -   Question 2: To start with, we would draw a scatter plot to look how the education level changed over the last years in different countries. Afterwards we can use faceted plots to see if there have been changed in other variables that affected the curve
